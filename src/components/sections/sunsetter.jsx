  ...
  animate() {
    ...
    const timelines = {
      elements: new TimelineLite()
        ...
        .fromTo(`${triggerElement} .browser-tab-1 .tab-element`, .01, { translateY: 24 }, { translateY: 0 }, .34)
        .fromTo(`${triggerElement} .browser-add-tab`, .01, { visibility: 'hidden' }, { visibility: 'visible' }, .36)
        .fromTo(`${triggerElement} .browser-add-tab .tab-element`, .01, { translateY: 24 }, { translateY: 0 }, .36)
        ...
        .to(`${triggerElement} .browser-add-tab .tab-element`, .01, { left: 244 }, .5)
        ...
        .to(`${triggerElement} .browser-add-tab .tab-element`, .01, { left: 366 }, .7)
